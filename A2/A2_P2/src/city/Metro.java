...
public class Metro extends CityBus {
	...
	public String toString() {
		return "This Metro has a price of " + this.getPrice() + ", " + this.getNumStops() + " stops, its route number " + this.getRouteNum() + ", begin operation year is " + this.getBeginYear() + ", line name " + getLineName() +
				" and driver is " + this.getDriverName() + ", operates in " + city + " and has " + numVehicles + " vehicles.";
	}
	/**
	...
	public boolean equals(Object check) {
		return super.equals(check) && (this.numVehicles == ((Metro)check).numVehicles) && (this.getLineName().equalsIgnoreCase(((Metro)check).getLineName()));
	}
}
