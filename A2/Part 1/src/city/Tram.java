...
public class Tram extends CityBus {
	...
	public String toString() {
		return "This Tram has a price of " + price + ", " + numStops + " stops, its route number " + routeNum + ", begin operation year is " + beginYear + ", line name " + lineName +
				" and driver is " + driverName + ", and maximum speed is " + maxSpeed;
